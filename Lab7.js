...
const nlFeedback=document.creatElement("div");
...
//====Contact Form (mailto:)====
const ctForm= document.getElmentById("contactFrom");
...
const CONTACT_TO_ADDRESS="Riversy2@winthrop.edu";
...
if (!isLikelyEmail(fromEmail)) {ctFeedback.textContent="Please enter a valid email address."; ctFeedback.className="feedback error"; ctEmail.focus(); return;}
if (!subj){ctFeedback.textContent="Please enter a subject."; ctFeedback.className="feedback error"; ctSubject.focus();return;}
if (!msg) {ctFeedback.textContent= "Please enter a message."; ctFeedback.className="feedback error"; ctMessage.focus(); return;}
